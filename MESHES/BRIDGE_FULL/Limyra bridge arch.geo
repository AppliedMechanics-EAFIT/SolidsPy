...
Transfinite Line {15, 13} = npts_arc1 Using Progression 1;
Transfinite Line {18, 20} = npts_arc2 Using Progression 1;
Transfinite Line {3, 4, 5, 14, 21} = npts_rad Using Progression 1;
...
// Physical groups
Physical Line("Top") = {13, 1};
Physical Line("Right") = {2};
Physical Surface("Body") = {9, 11, 12, 17};
